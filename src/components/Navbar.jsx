            ...
            >
                <div className="container" style={styles.container}>
                    ...
                    <ul style={styles.desktopLinks} className="desktop-only">
                        ...
                        <li>
                            <a href={`${import.meta.env.BASE_URL}resume.pdf`} target="_blank" rel="noopener noreferrer" style={{ ...styles.cta, background: 'transparent', border: '1px solid var(--border-focus)' }}>
                                Resume
                            </a>
                        </li>
                        <li>
                ...
                {isMobileMenuOpen && (
                    ...
                    >
                        <ul style={styles.mobileLinks}>
                            ...
                            <li>
                                <a href={`${import.meta.env.BASE_URL}resume.pdf`} target="_blank" rel="noopener noreferrer" onClick={toggleMenu} style={{ color: 'var(--text-secondary)' }}>Resume PDF</a>
                            </li>
                        </ul>
                    </motion.div>
                )}
